...
if (nSel > 0) {
    ...
    for (var i = nSel - 1; i >= 0; i--) {
        ...
        var newRectangle = doc.activeLayer.pathItems.rectangle(yCircle, xCircle, cirWidth, cirHeigth, false, true);
        newRectangle.filled = true;
        newRectangle.fillColor = selItem.fillColor;
        newRectangle.stroked = true;
        newRectangle.strokeColor = selItem.strokeColor;
        newRectangle.strokeWidth = selItem.strokeWidth;
        newRectangle.strokeCap = selItem.strokeCap;
