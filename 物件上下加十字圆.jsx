...
var w = new Window("dialog", "输入距离大小");
w.add("StaticText", undefined, "请输入距离大小，单位为mm:");
var inputBox = w.add("edittext", undefined, "1.5");
inputBox.characters = 10;
var btnGroup = w.add("group");
var okButton = btnGroup.add("button", undefined, "确定");
var cancelButton = btnGroup.add("button", undefined, "取消");
...
okButton.onClick = function () {
    ...
    if (nSel > 0) {
        ...
        var mChuxue = inputBox.text;
        var mChuxueValue = new UnitValue(parseFloat(mChuxue), "mm").as("pt");
        ...
        pg1(mChuxueValue, rCircle, lRegXian, myBounds, xRegCrossLeft, yRegs, xRegCrossTop, yRegCrossRight, leftRegX, topRegY, newCMYKColor);
...
function pg1(mChuxueValue, rCircle, lRegXian, myBounds, xRegCrossLeft, yRegs, xRegCrossTop, yRegCrossRight, leftRegX, topRegY, newCMYKColor) {
    //先画十字圆
    ///圆
