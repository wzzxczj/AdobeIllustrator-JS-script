...
if (nSel > 0) {
    ...
    // 创建自定义对话框
    var dialog = new Window("dialog", "选项");
    dialog.orientation = "column";

    var delOriGroup = dialog.add("group");
    delOriGroup.add("statictext", undefined, "是否删除原图？");
    var delOriCheckbox = delOriGroup.add("checkbox", undefined, "是");
    delOriCheckbox.value = true; // 默认选中

    var newLayerGroup = dialog.add("group");
    newLayerGroup.add("statictext", undefined, "是否在新图层上创建？");
    var newLayerCheckbox = newLayerGroup.add("checkbox", undefined, "是");
