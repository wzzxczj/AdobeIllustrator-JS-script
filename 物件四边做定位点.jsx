...
if (nSel > 0) {
    ...
    if (confirmed) {
        ...
        for (var xSel = 0; xSel < selected.length; xSel++) {
            ...
            var minLength = new UnitValue(120, "mm").as("pt");
